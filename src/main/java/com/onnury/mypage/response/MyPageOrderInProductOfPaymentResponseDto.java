...
import com.onnury.product.response.ProductOptionCreateResponseDto;
...
@Builder
@Getter
public class MyPageOrderInProductOfPaymentResponseDto {
    ...
    private String productDetailOptionTitle; // 제품 상세 옵션 명
    ...
    private int sellPrice; // 판매 가격 (totalPrice)
