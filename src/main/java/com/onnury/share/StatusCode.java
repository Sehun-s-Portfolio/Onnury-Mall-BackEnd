...
public enum StatusCode {
    ...
    NOT_EXIST_MIDDLE_CATEGORIES_RELATED_UP_CATEGORY("선택한 대분류 카테고리에 해당되는 중분류 카테고리를 조회할 수 없습니다.", "O-419"),
    ...
    NOT_ADMIN_ACCOUNT_FOR_NOTICE("공지사항을 작성할 수 없습니다.", "O-431"),
    ...
    CANT_CHANGE_USER_PASSWORD("회원 비밀번호를 변경할 수 없습니다.", "O-447"),
    NOT_EXIST_SUPPLIER("공급사 정보가 존재하지 않습니다.", "O-448"),
    NOT_EXIST_CATEGORY("카테고리 정보가 존재하지 않습니다.", "O-449"),
    NOT_EXIST_MEMBER("회원 정보가 존재하지 않습니다.", "O-450"),
    NOT_EXIST_INQUIRY("문의 정보가 존재하지 않습니다.", "O-451"),
    NOT_EXIST_PAYMENT("결제 정보가 존재하지 않습니다.", "O-452"),
    NOT_EXIST_ORDER("주문 정산 정보가 존재하지 않습니다.", "O-453"),
    CANT_CREATE_LABEL("라벨을 생성할 수 없습니다.", "O-454"),
    CANT_UPDATE_LABEL("라벨을 수정할 수 없습니다.", "O-455"),
    CANT_DELETE_LABEL("라벨을 삭제할 수 없습니다.", "O-456"),
    CANT_GET_LABEL_LISTUP("라벨 정보가 존재하지 않아 라벨 리스트를 호출할 수 없습니다.", "O-457"),
    CANT_GET_TOP_EXPRESS_LABEL_LIST("라벨 정보가 존재하지 않아 상위 노출 라벨 리스트를 호출할 수 없습니다.", "O-458"),
    NOT_EXIST_PRODUCT_DETAIL("제품 상세 정보가 존재하지 않습니다." ,"O-459"),
    NOT_EXIST_BRAND_PRODUCTS("해당되는 브랜드 제품들이 존재하지 않습니다.", "O-460"),
    CANT_UPDATE_SUPPLIER("공급사 정보를 수정할 수 없습니다.", "O-461"),
    CANT_DELETE_SUPPLIER("공급사 정보를 삭제할 수 없습니다.", "O-462"),
    DUPLICATE_SUPPLIER_ID("중복된 공급사 아이디입니다.", "O-463"),
    CANT_GET_MY_CANCEL_PAYMENTS("취소 이력을 조회할 수 없습니다.", "O-464"),
    CANT_REQUEST_PAYMENT_CANCEL("주문을 취소할 수 없습니다.", "O-465"),
    CANT_UPDATE_NOTICE("공지사항을 수정할 수 없습니다.", "O-466"),
    CANT_DELETE_NOTICE("공지사항을 삭제할 수 없습니다.", "O-467"),
    CANT_GET_ORDER_LIST("결제 주문 리스트들을 조회할 수 없습니다.", "O-468"),
    CANT_GET_MEMBER_ORDER_LIST("회원의 결제 주문 리스트를 조회할 수 없습니다.", "O-469"),
    CANT_GET_ORDER_DETAIL("결제 상세 정보를 조회할 수 없습니다.", "O-470"),
    CANT_GET_CANCEL_ORDER_LIST("결제 주문 취소 이력 리스트를 조회할 수 없습니다.", "O-471"),
    CANT_GET_SUPPLIER_ORDER_LIST("공급사에 해당되는 결제 주문 이력 리스트를 조회할 수 없습니다.", "O-472"),
    CANT_CONFIRM_TRANSPORT_NUMBER("운송장 번호 업데이트에 실패하였습니다.", "O-473");
